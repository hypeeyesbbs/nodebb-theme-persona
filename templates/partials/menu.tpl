...
<!--				</button>-->
				...
				<div class="navbar-title-toggle show pull-left" style="background-color: transparent;">
					<li id="news-category" class="nav-title dropdown" data-animation>
						...
						<ul id="news-list" class="dropdown-menu pull-left" style="top:49px;width: 100%;text-align:center;">
							<li>
				...
				<div class="navbar-title-toggle show pull-left" style="background-color: transparent;">
					<li id="wiki-category" class="nav-title dropdown" data-animation>
						...
						<ul id="wiki-list" class="dropdown-menu pull-left" style="top:49px;width: 100%;text-align:center;">
							<li>
				...
				<div class="navbar-title-toggle show pull-left" style="background-color: transparent;">
					<li id="forum-category" class="nav-title dropdown" data-animation>
						...
						<ul id="forum-list" class="dropdown-menu pull-left" style="top:49px;width: 100%;text-align:center;">
							<li>
				...
				<button type="button" class="new-topic-button navbar-title-toggle show pull-left" style="background-color: transparent;">
					<li class="nav-title">
						<a href="#" id="new_topic" style="font-weight: 500; font-size: 15px; color: #F8BD2C;">发帖</a>
					</li>
				</button>
